...
async def generate_report_plan(state: ReportState, config: RunnableConfig):
    ...
    if planner_model == "claude-3-7-sonnet-latest":
        ...
        planner_llm = init_chat_model(
            model=planner_model, model_provider=planner_provider, model_kwargs=planner_model_kwargs
        )
...
# Add nodes
builder = StateGraph(
    ReportState, input=ReportStateInput, output=ReportStateOutput, config_schema=Configuration
)
